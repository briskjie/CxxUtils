...
public class VerticalLayout extends FrameLayout {
    private String TAG = "cxx-竖滑布局";
    public VerticalLayout(@NonNull Context context) {
        super(context);
    }

    public VerticalLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public VerticalLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
